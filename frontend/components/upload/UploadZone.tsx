  ...
  return (
    <div className="bg-[#0a0a0f] text-white">
      ...
      <footer className="relative z-10 border-t border-white/5 px-8 py-6 flex items-center justify-between">
        <span className="text-gray-400 text-xs">© 2026 OpenParsed</span>
        <div className="flex items-center gap-4">
          <span className="text-gray-400 text-xs">For accountants, CAs &amp; auditors</span>
          <a href="mailto:priyeshpandey2000@gmail.com" className="text-gray-400 text-xs hover:text-white transition-colors">Contact</a>
          <a href="/privacy" className="text-gray-400 text-xs hover:text-white transition-colors">Privacy Policy</a>
        </div>
      </footer>
