    ...
    <div className="flex h-screen flex-col bg-neutral-950 text-neutral-100">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className="w-56 shrink-0 border-r border-neutral-800/60 flex flex-col bg-[#0d0d0d]">
          ...
          <div className="px-3 flex items-center gap-2" style={{ paddingTop: 12, paddingBottom: 16 }}>
          ...
          <div className="flex-1 overflow-y-auto px-2 pb-3 space-y-1" style={{ paddingTop: 20 }}>
